local function callback_reply(extra, success, result)
	--icon & rank ------------------------------------------------------------------------------------------------
	userrank = "Member"
	if tonumber(result.from.id) == 24709501 then
		userrank = "Master ⭐⭐⭐⭐"
		send_document(org_chat_id,"data/master.webp", ok_cb, false)
	elseif is_sudo(result) then
		userrank = "Sudo ⭐⭐⭐⭐⭐"
		send_document(org_chat_id,"data/sudo.webp", ok_cb, false)
	elseif is_admin2(result.from.id) then
		userrank = "Admin ⭐⭐⭐"
		send_document(org_chat_id,"data/admin.webp", ok_cb, false)
	elseif is_owner2(result.from.id, result.to.id) then
		userrank = "Leader ⭐⭐"
		send_document(org_chat_id,"data/leader.webp", ok_cb, false)
	elseif is_momod2(result.from.id, result.to.id) then
		userrank = "Moderator ⭐"
		send_document(org_chat_id,"data/mod.webp", ok_cb, false)
	elseif tonumber(result.from.id) == tonumber(our_id) then
		userrank = "Umbrella-Cp ⭐⭐⭐⭐⭐⭐"
		send_document(org_chat_id,"data/umb.webp", ok_cb, false)
	elseif result.from.username then
		if string.sub(result.from.username:lower(), -3) == "bot" then
			userrank = "API Bot"
			send_document(org_chat_id,"data/api.webp", ok_cb, false)
		end
	end
	--custom rank ------------------------------------------------------------------------------------------------
...
local function callback_res(extra, success, result)
	...
	--icon & rank ------------------------------------------------------------------------------------------------
	if tonumber(result.id) == 24709501 then
		userrank = "Master ⭐⭐⭐⭐"
		send_document(org_chat_id,"data/master.webp", ok_cb, false)
	elseif is_sudo(result) then
		userrank = "Sudo ⭐⭐⭐⭐⭐"
	...
	elseif #matches == 2 then
		...
		if not msg.reply_id then
			...
			if tonumber(msg.from.id) == 122774063 then
				userrank = "Master ⭐⭐⭐⭐"
				send_document("chat#id"..msg.to.id,"data/master.webp", ok_cb, false)
			elseif is_sudo(msg) then
				userrank = "Sudo ⭐⭐⭐⭐⭐"
				send_document("chat#id"..msg.to.id,"data/sudo.webp", ok_cb, false)
			elseif is_admin(msg) then
				userrank = "Admin ⭐⭐⭐"
				send_document("chat#id"..msg.to.id,"data/admin.webp", ok_cb, false)
			elseif is_owner(msg) then
				userrank = "Leader ⭐⭐"
				send_document("chat#id"..msg.to.id,"data/leader.webp", ok_cb, false)
			elseif is_momod(msg) then
				userrank = "Moderator ⭐"
				send_document("chat#id"..msg.to.id,"data/mod.webp", ok_cb, false)
			else
				userrank = "Member"
			end
			--number ------------------------------------------------------------------------------------------------
